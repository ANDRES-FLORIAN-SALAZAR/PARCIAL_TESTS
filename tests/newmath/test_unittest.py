...
class TestContarVocales(unittest.TestCase):
    def test_deberia_contar_vocales_en_una_frase(self):
        ...
        esperado = 6
        self.assertEqual(esperado, resultado, "test_deberia_contar_vocales")
...
class TestFactorFibonacci(unittest.TestCase):
    def test_deberia_calcular_factor_fibonacci_con_valores_por_defecto(self):
        ...
        esperado = 1.0
        self.assertEqual(esperado, resultado, "test_deberia_calcular_factor_fibonacci_con_valores_por_defecto")
